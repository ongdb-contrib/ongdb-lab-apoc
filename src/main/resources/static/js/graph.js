...
function load() {
    ...
    // 使用HTTP服务请求数据
    d3.json("http://localhost:8000/graph-import-csv/check-graph-traversal.json", function (error, data) {
        if (error) {
    ...
    // var json ={"nodes":[{"image":"default.png","name":"胡总马甲","index":0,"id":22742},{"image":"default.png","name":"南宁律师覃永沛","index":1,"id":1405802},{"image":"default.png","name":"美国优先_1708","index":2,"id":2884470},{"image":"default.png","name":"LDR测试_842","index":3,"id":19807},{"image":"default.png","name":"杨l幂后援会_3270642935_微信","index":4,"id":20103},{"image":"default.png","name":"大幂幂","index":5,"id":19798}],"links":[{"sourceId":22742,"targetId":2884470,"id":5197640,"source":0,"type":"参与事件","target":2},{"sourceId":1405802,"targetId":2884470,"id":5217323,"source":1,"type":"参与事件","target":2},{"sourceId":22742,"targetId":19807,"id":29840,"source":0,"type":"参与事件","target":3},{"sourceId":1405802,"targetId":19807,"id":3391974,"source":1,"type":"参与事件","target":3},{"sourceId":19798,"targetId":20103,"id":26521,"source":5,"type":"隶属虚拟账号","target":4},{"sourceId":19798,"targetId":19807,"id":2127500,"source":5,"type":"参与事件","target":3}]}
    // ;
