package data.lab.ongdb.load.util;
...
/**
 * @author Yc-Ma
 * @PACKAGE_NAME: data.lab.ongdb.load.util.JdbcUtil
 * @Description: TODO
 * @date 2021/4/8 8:53
 */
public class JdbcUtil {

    private static final String KEY_NOT_FOUND_MESSAGE = "No olab.jdbc.%s.url url specified";
